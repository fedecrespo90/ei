...
Login.post = function(req, res, next) {
  Auth.doLogin(req.body.usuario, req.body.pass, function(usuario) {
    if (usuario) {
      req.session.regenerate(function() {
        ...
        req.session.empleado_id = usuario.empleado_id;
        var ini_routes = [
          '/#/inicio/novTarea',	//operador 
          '/#/inicio/novTarea',	//supervisor
          '/#/inicio/novTarea',	//administrador
          '/#/ie/clientePago',  //sysadmin
        ];
        res.redirect(ini_routes[usuario.rol_id-1]);
      });
    } else {
