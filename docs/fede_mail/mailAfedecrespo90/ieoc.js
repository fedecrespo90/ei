      ...
      DB.Oc.max('numero').on('success',function(numero){
        ...
        if(req.body.notificarCliente==1){
          ...
          var transport = nodemailer.createTransport("SMTP", {
            auth: {
              user: "fedecrespo90@gmail.com", //edu0221@hotmail.com
          ...
          DB.Cliente.find({where: {id: req.body.cliente_id}}).on('success', function(cliente){
            ...
            DB.Novedades.create({
              ...
              var mailOptions = {
                from: "fedecrespo90@gmail.com", //edu0221@hotmail.com
                to: "fedecrespo90@gmail.com",
                bcc: "fedecrespo90@gmail.com",
                subject: "Estudio Integral Pressacco y Asoc. - Orden de Consulta",
                replyTo:  "fedecrespo90@gmail.com", //edu0221@hotmail.com
                html: htmlText,
    ...
    DB.Cliente.find({where: {id: req.body.cliente_id}}).on('success', function(cliente){
      DB.Empleado.find({where: {id: req.body.empleado_id}}).on('success', function(user){
          ...
          var mailOptions = {
            ...
            bcc: "fedecrespo90@gmail.com", //edu0221@hotmail.com
            subject: "Estudio Integral Pressacco y Asoc. - Orden de Consulta",
            replyTo:  "fedecrespo90@gmail.com", //edu0221@hotmail.com
            html: htmlText,
            forceEmbeddedImages: true
