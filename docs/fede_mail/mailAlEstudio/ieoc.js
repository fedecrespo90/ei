          ...
          DB.Cliente.find({where: {id: req.body.cliente_id}}).on('success', function(cliente){
            ...
            DB.Novedades.create({
              ...
              transport.sendMail(mailOptions, function(error, response) {
                console.log("MAIL ENVIADO A:"+mailOptions.to+"TEXTO="+htmlText)
              });
            })
          })
        }else
  ...
  if(req.body.notificarCliente==1){
    ...
    DB.Cliente.find({where: {id: req.body.cliente_id}}).on('success', function(cliente){
      DB.Empleado.find({where: {id: req.body.empleado_id}}).on('success', function(user){
          ...
          console.log("ESTOT POR ACA")
          transport.sendMail(mailOptions, function(error, response) {
            if(error)
            console.log("MAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADOMAIL ENVIADO A:"+mailOptions.to+"TEXTO="+htmlText)
          });
        })
      })
    })
